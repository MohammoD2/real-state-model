...
new_df = pd.read_csv(r"E:\Work files\Real_state\Real state\data\raw\data_viz1.csv")
# feature_text = pickle.load(open("E:\\Work files\\Real_state\\Real state\\datasets\\feature_text.pkl", 'rb'))
with open(r"E:\Work files\Real_state\Real state\data\raw\feature_text.pkl", 'rb') as file:
    feature_text = pickle.load(file)
